    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-[480px] border-none shadow-2xl rounded-[2.5rem] p-0 overflow-hidden">
                <DialogHeader className="p-8 bg-emerald-500/5 border-b border-emerald-500/10">
                    <div className="flex items-center gap-4 mb-2">
                        <div className="h-12 w-12 rounded-2xl bg-emerald-500/10 flex items-center justify-center text-emerald-500 shadow-lg shadow-emerald-500/5">
                ...
                <div className="p-6 space-y-6">
                    ...
                    <div className="grid grid-cols-3 gap-3">
                        ...
                        <div className="text-center p-3 bg-emerald-500/5 rounded-xl border border-emerald-500/10">
                            <p className="text-[9px] font-black uppercase tracking-widest text-emerald-600/50 mb-1">
                                Paid
                            </p>
                        ...
                        <div className="text-center p-3 bg-amber-500/5 rounded-xl border border-amber-500/10">
                            <p className="text-[9px] font-black uppercase tracking-widest text-amber-600/50 mb-1">
                                Due
                            </p>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <Input
                                ...
                                className="h-14 rounded-xl bg-muted/20 border-none font-black text-xl text-center"
                            />
                        </div>
                    ...
                    <div className="flex items-center justify-between text-[10px] font-black uppercase tracking-widest text-muted-foreground/50">
                        ...
                        >
                            {amount >= dueAmount ? (
                                ...
                                `${formatCurrency(dueAmount - amount)} REMAINING`
                            )}
                        </Badge>
                    </div>

                    <Button
                        className="w-full h-14 rounded-2xl bg-emerald-600 hover:bg-emerald-700 font-black uppercase tracking-[0.15em] text-xs shadow-xl shadow-emerald-500/20 transition-all flex items-center justify-center gap-2"
                    ...
                    <Button
                        variant="ghost"
                        className="w-full rounded-xl font-bold text-muted-foreground h-10"
