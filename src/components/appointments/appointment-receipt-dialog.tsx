...
interface AppointmentReceiptDialogProps {
  open: boolean
...
export function AppointmentReceiptDialog({ open, onOpenChange, transaction, doctors = [], staffs = [], patient: propPatient, doctor: propDoctor }: AppointmentReceiptDialogProps) {
  ...
  const aptSerial = data?.appointment?.serialNumber || transaction?.serialNumber || "N/A"
