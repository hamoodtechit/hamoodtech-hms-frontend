    ...
    <div className={`p-2 ${isPrinting ? 'space-y-1' : 'space-y-3'} border-b border-black border-dashed pb-6 print:border-b-0 print:pb-0 relative`}>
        ...
        <div className={`text-center ${isPrinting ? 'text-[7.5px] space-y-0.5 pt-2 mt-2' : 'text-[10px] space-y-2 pt-4 mt-4'} text-black border-t-2 border-dashed border-black/20 uppercase`}>
            <div className={`flex justify-between items-center mb-2 text-left ${isPrinting ? 'text-[8px]' : 'text-xs'}`}>
                <span className="font-black">Billing By: {(data as any)?.createdBy || user?.fullName || user?.username || "Staff"}</span>
            </div>
                    ...
                    <div class="container">
                        ...
                        <div class="footer">
                            <div style="display: flex; justify-content: space-between; margin-bottom: 5px; font-size: 10px;">
                                <span style="font-weight: 900; text-align: left; text-transform: uppercase;">Billing By: ${(data as any)?.createdBy || user?.fullName || user?.username || 'Staff'}</span>
                            </div>
