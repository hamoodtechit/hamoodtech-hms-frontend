...
import { Loader2, CheckCircle2, Receipt, Building2, BedDouble, ChevronLeft } from "lucide-react"
                        ...
                        <Table>
                            <TableHeader className="bg-muted/30 sticky top-0 z-10 shadow-sm">
                                <TableRow className="hover:bg-transparent">
                                    <TableHead className="pl-6 h-12 text-[10px] font-black uppercase tracking-widest">Invoice Number</TableHead>
